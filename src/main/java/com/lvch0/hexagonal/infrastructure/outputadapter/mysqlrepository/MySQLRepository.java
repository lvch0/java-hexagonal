package com.lvch0.hexagonal.infrastructure.outputadapter.mysqlrepository;
...
public class MySQLRepository implements EntityRepository {
    ...
    public <T> T save(T reg) {
        ...
        sql.append("INSERT INTO").append(reg.getClass().getSimpleName()).append("(").append(String.join(",", fields))
    ...
    public class LombokRowMapper<T> implements RowMapper<T> {
